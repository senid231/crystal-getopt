...
class GetOpt
  ...
  def self.getopt(args : Array(String), shortopts : String, longopts=Array(String).new : Array(String)|String) : {Array(Hash(String, String)), Array(String)}
  ...
  def self.getopt(args : String, shortopts : String, longopts=Array(String).new : Array(String)|String) : {Array(Hash(String, String)), Array(String)}
    return getopt(args.split(" "), shortopts, longopts)
  end


  private def self.get_longopts(opts : Array(Hash(String, String)), args : Array(String), longopts : Array(String)) : {Array(Hash(String, String)), Array(String)}
  ...
  private def self.get_shortopts(opts : Array(Hash(String, String)), args : Array(String), shortopts : String) : {Array(Hash(String, String)), Array(String)}
